...
private int[] openSites;
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(p.isTop(2));
        StdOut.println(p.isBottom(8));
        ...
        StdOut.println(p.wquf.connected(1, 8));
        StdOut.println(p.wquf.connected(8, 10));
        StdOut.println("find ----");
